# Bug Report: RF-04 - Módulo de Pontuação e Ranking

**Título:** Falha na subtração de pontos do saldo do usuário ao excluir check-in (Violação do RF-08)
...
## 7. Evidências
# Bug Report: BUG-010 - Módulo de Pontuação e Ranking
